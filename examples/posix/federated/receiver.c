...
LF_DEFINE_STARTUP_COORDINATOR_STRUCT(Federate, 1, 8);
LF_DEFINE_SHUTDOWN_COORDINATOR_STRUCT(Federate, 6);
LF_DEFINE_STARTUP_COORDINATOR_CTOR(Federate, 1, 1, 8, 5, JOIN_IMMEDIATELY);
LF_DEFINE_SHUTDOWN_COORDINATOR_CTOR(Federate, 1, 6);
