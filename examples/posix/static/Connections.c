...
// Reaction deadline violation handlers

// Reaction STP violation handlers
...
LF_DEFINE_DELAYED_CONNECTION_CTOR(Reactor_Connections, conn_r3_out_0, 1, 1, false);
LF_DEFINE_LOGICAL_CONNECTION_CTOR(Reactor_Connections,  conn_r1_out_1, 1);
LF_REACTOR_CTOR_SIGNATURE(Reactor_Connections) {
   ...
   LF_INITIALIZE_DELAYED_CONNECTION(Reactor_Connections, conn_r3_out_0, MSEC(10), 1, 1);
   LF_INITIALIZE_LOGICAL_CONNECTION(Reactor_Connections, conn_r1_out_1, 1, 1);
   // Do connections 
   lf_connect((Connection *) &self->conn_r3_out_0[0][0], (Port *) &self->r3[0].out[0], (Port *) &self->r4[0].in[0]);
   lf_connect((Connection *) &self->conn_r1_out_1[0][0], (Port *) &self->r1[0].out[0], (Port *) &self->r2[0].in[0]);
