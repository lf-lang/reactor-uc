...
// Connection structs
LF_DEFINE_DELAYED_CONNECTION_STRUCT(Reactor_Connections, conn_r3_out_0, 1, int, 1);
LF_DEFINE_LOGICAL_CONNECTION_STRUCT(Reactor_Connections,  conn_r1_out_1, 1);
...
typedef struct {
  ...
  // Connections 
  LF_DELAYED_CONNECTION_INSTANCE(Reactor_Connections, conn_r3_out_0, 1, 1);
  LF_LOGICAL_CONNECTION_INSTANCE(Reactor_Connections, conn_r1_out_1, 1, 1);
  // Ports 
