...
#define LF_CONN_REGISTER_DOWNSTREAM(Conn, BankWidthUp, PortWidthUp, ReactorDown, PortDown, BankWidthDown, PortWidthDown)  \
...
#define LF_DEFINE_REACTION_CTOR(ReactorName, ReactionName, Priority)                                                      \
