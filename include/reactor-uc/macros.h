...
#define max(left, right) __extension__ ({               \
    __typeof__(left) _left = (left);                                                                                   \
    __typeof__(right) _right = (right);                                                                                \
    _left > _right ? _left : _right;                                                                                   \
  })

#define lf_set(port, input) __extension__ ({                                                                                         \
    port->value = input;                                                                                               \
...
#define lf_schedule_value(logical_action, interval_time, value) __extension__ ({                                                                                                                   \
...
#define lf_action_get(logical_action) __extension__ ({                                                                               \
