  ...
  fun doGenerateIncludeCmake(sources: List<Path>, compileDefs: List<String>) =
    with(PrependOperator) {
      """ |# This file was generated by the Lingua Franca Compiler for the program $mainTarget
            ...
            |set(LFC_GEN_SOURCES
        ${
        " |    "..sources.filterNot { it.name == "lf_main.c" }
          .joinWithLn { "$S{CMAKE_CURRENT_LIST_DIR}/${it.toUnixString()}" }
      }
            |)
...
class UcCmakeGeneratorFederated(
  ...
  private val targetConfig: TargetConfig,
  fileConfig: UcFileConfig,
) : UcCmakeGenerator(UcLoggingLevelAttribute(federate.inst.eContainer() as Reactor), targetConfig, fileConfig) {
