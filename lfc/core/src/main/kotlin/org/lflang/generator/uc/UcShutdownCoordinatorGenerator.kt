...
class UcShutdownCoordinatorGenerator(
    ...
    fun generateSelfStruct() =
        "LF_DEFINE_SHUTDOWN_COORDINATOR_STRUCT(${typeName}, ${numNeighbors}, ${numSystemEvents})"

    fun generateCtor() =
        "LF_DEFINE_SHUTDOWN_COORDINATOR_CTOR(Federate, ${numNeighbors}, ${longestPath}, ${numSystemEvents});"
