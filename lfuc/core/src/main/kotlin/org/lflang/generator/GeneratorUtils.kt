...
/** Returns the target code for the [getActualValue] of the param for this instantiation. */
...
/**
 * Return the actual value of a parameter for the given instantiation. The value is defaulted to the
 * default value for the parameter if there is no explicit assignment. If there is no default value,
 * the source code is invalid (param is required)
 */
...
/** Return the target code for the given expression, given that it's a time expression. */
