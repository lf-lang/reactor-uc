...
int _NoEncryptionLayer_receive_callback(EncryptionLayer* untyped_self, char* buffer, size_t buffer_size) {
...
void NoEncryptionLayer_ctor(NoEncryptionLayer* self, NetworkChannel* network_channel) {
  ...
  network_channel->register_encryption_layer(network_channel, (EncryptionLayer*)self, _NoEncryptionLayer_receive_callback);
