...
static void _CoapUdpIpChannel_update_state(CoapUdpIpChannel *self, NetworkChannelState state) {
  ...
  static CoapUdpIpChannel *_CoapUdpIpChannel_get_coap_channel_by_remote(const sock_udp_ep_t *remote) {
    ...
    static bool _CoapUdpIpChannel_send_coap_message(sock_udp_ep_t * remote, char *path,
      ...
      static bool _CoapUdpIpChannel_send_coap_message_with_payload(CoapUdpIpChannel * self, sock_udp_ep_t * remote,
                                                                   char *path, gcoap_resp_handler_t resp_handler,
        ...
        static bool _CoapUdpIpChannel_send_coap_message_with_payload(CoapUdpIpChannel * self, sock_udp_ep_t * remote,
          ...
          if (pdu.payload_len < payload_len) {
            LF_ERR(NET, "CoapUdpIpChannel: Send CoAP message: msg buffer too small (%d < %d)", pdu.payload_len,
                   payload_len);
            return false;
          }
          ...
          ssize_t bytes_sent =
              gcoap_req_send(self->write_buffer, len, remote, NULL, resp_handler, NULL, GCOAP_SOCKET_TYPE_UDP);
          LF_DEBUG(NET, "CoapUdpIpChannel: Sending %d bytes", bytes_sent);
          if (bytes_sent > 0) {
            LF_DEBUG(NET, "CoapUdpIpChannel: Successfully sent");
            return true;
          ...
          static ssize_t _CoapUdpIpChannel_server_disconnect_handler(coap_pkt_t * pdu, uint8_t * buf, size_t len,
            ...
            static ssize_t _CoapUdpIpChannel_server_message_handler(coap_pkt_t * pdu, uint8_t * buf, size_t len,
              ...
              static gcoap_listener_t _listener = {
                  &_resources[0], ARRAY_SIZE(_resources), GCOAP_SOCKET_TYPE_UDP, NULL, NULL, NULL};
              ...
              static void _CoapUdpIpChannel_client_try_connect_callback(const gcoap_request_memo_t *memo,
                                                                        coap_pkt_t *pdu, const sock_udp_ep_t *remote) {
                static void _CoapUdpIpChannel_client_try_connect_callback(
                ...
                static lf_ret_t CoapUdpIpChannel_try_connect(NetworkChannel * untyped_self) {
                  ...
                  static void _CoapUdpIpChannel_client_close_connection_callback(
                      const gcoap_request_memo_t *memo, coap_pkt_t *pdu, const sock_udp_ep_t *remote) {
                    static void _CoapUdpIpChannel_client_close_connection_callback(
                        const gcoap_request_memo_t *memo, coap_pkt_t *pdu, const sock_udp_ep_t *remote) {
                    ...
                    static void CoapUdpIpChannel_close_connection(NetworkChannel * untyped_self) {
                      ...
                      _CoapUdpIpChannel_send_coap_message(&self->remote, "/disconnect",
                                                          _CoapUdpIpChannel_client_close_connection_callback);
                      _CoapUdpIpChannel_send_coap_message(&self->remote, "/disconnect",
                                                          _CoapUdpIpChannel_client_close_connection_callback);
                    }

                    static void _CoapUdpIpChannel_client_send_blocking_callback(
                        const gcoap_request_memo_t *memo, coap_pkt_t *pdu, const sock_udp_ep_t *remote) {
                      static void _CoapUdpIpChannel_client_send_blocking_callback(
                          const gcoap_request_memo_t *memo, coap_pkt_t *pdu, const sock_udp_ep_t *remote) {
                      ...
                      static lf_ret_t CoapUdpIpChannel_send_blocking(NetworkChannel * untyped_self,
                                                                     const FederateMessage *message) {
                        LF_DEBUG(NET, "CoapUdpIpChannel: Send blocking");
                        CoapUdpIpChannel *self = (CoapUdpIpChannel *)untyped_self;

                        // Send message
                        if (_CoapUdpIpChannel_send_coap_message_with_payload(
                                self, &self->remote, "/message", _CoapUdpIpChannel_client_send_blocking_callback,
                                message)) {
                          if (_CoapUdpIpChannel_send_coap_message_with_payload(
                                  self, &self->remote, "/message", _CoapUdpIpChannel_client_send_blocking_callback,
                                  message)) {
                        ...
                        static void CoapUdpIpChannel_register_receive_callback(
                        ...
                        static NetworkChannelState CoapUdpIpChannel_get_connection_state(NetworkChannel *
                                                                                         untyped_self) {
                          CoapUdpIpChannel *self = (CoapUdpIpChannel *)untyped_self;
                        ...
                        void CoapUdpIpChannel_ctor(CoapUdpIpChannel * self, Environment * env,
                                                   const char *remote_address, int remote_protocol_family) {
                          assert(self != NULL);
                          assert(env != NULL);
